...
class Environment{
  ...
  //   noFill();
  //   stroke(100);
  //   rect(mover.pos.x-(obsWidth/2), mover.pos.y-(obsHeight/2), obsWidth, obsHeight);
  //   this.show();
  //   var imageData = get(mover.pos.x-(obsWidth/2), mover.pos.y-(obsHeight/2), obsWidth, obsHeight);
  //   imageData.loadPixels();
  //   //console.log(imageData.pixels.length);
  //   for(let i = 0; i < obsWidth*obsHeight*4; i += 4)
  //     pix.push((imageData.pixels[i]+imageData.pixels[i+1]+imageData.pixels[i+2])/3);
  //   // image(imageData,10,10);
  //   // console.log(pix);
  //   return pix;
  // }
